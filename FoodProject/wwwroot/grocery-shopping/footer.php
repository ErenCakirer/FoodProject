<footer>
  ...
  <div class="copyright">
        ...
        <div class="copy-text">
          ...
          <?php
            if (!get_theme_mod('grocery_shopping_footer_text') ) { ?>
              <a target="_blank" href="<?php echo esc_url(__('https://www.misbahwp.com/products/free-grocery-wordpress-theme', 'grocery-shopping' )); ?>" target="_blank">
          ...
          <?php endif; ?>
                <?php $grocery_shopping_footer_settings = get_theme_mod( 'grocery_shopping_footer_social_links_settings' ); ?>
                <?php if ( is_array($grocery_shopping_footer_settings) || is_object($grocery_shopping_footer_settings) ){ ?>
                        <?php foreach( $grocery_shopping_footer_settings as $grocery_shopping_footer_setting ) { ?>
                        <a class="social-links" href="<?php echo esc_url( $grocery_shopping_footer_setting['link_url'] ); ?>">
                            <i class="<?php echo esc_attr( $grocery_shopping_footer_setting['link_text'] ); ?> me-3"></i>
                        </a>
                    <?php } ?>
                <?php } ?>
        </p>
    ...
    <?php $grocery_shopping_scroll_top_icon = get_theme_mod( 'grocery_shopping_scroll_top_icon', 'dashicons dashicons-arrow-up-alt' ); ?>
    <?php if ( get_theme_mod('grocery_shopping_scroll_enable_setting', true) == true ) : ?>
      <div class="scroll-up">
          <a href="#tobottom"><span class="dashicons dashicons-<?php echo esc_attr( $grocery_shopping_scroll_top_icon ); ?>"></span></a>
      </div>
    <?php endif; ?>
