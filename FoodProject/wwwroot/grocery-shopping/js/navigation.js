// Menu Functions
function grocery_shopping_openNav() {
  jQuery(".sidenav").addClass('show');
}

function grocery_shopping_closeNav() {
  jQuery(".sidenav").removeClass('show');
}

/////////////////////// Focus handling ///////////////////////
(function(window, document) {
  function grocery_shopping_handleMobileMenuNavigation() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    grocery_shopping_handleMobileMenuNavigation();
